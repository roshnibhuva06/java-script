...
let recipes = recipesdata.recipes;
  ...
  recipes.forEach((e) => {
    ...
    document.write(e.id + "<br>")
    document.write(e.name + "<br>");
    document.write(e.ingredients + "<br>")
    document.write(e.instructions + "<br>")
    document.write(e.prepTimeMinutes + "<br>")
    document.write(e.cookTimeMinutes + "<br>")
    document.write(e.servings + "<br>")
    document.write(e.difficulty + "<br>")
    document.write(e.cuisine + "<br>")
    document.write(e.caloriesPerServing + "<br>")
    document.write(e.tags + "<br>")
    document.write(e.userId + "<br>")
    document.write(e.rating + "<br>")
    document.write(e.reviewCount + "<br>")
    document.write(e.mealType + "<br>")
